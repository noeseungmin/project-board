...
class PaginationServiceTest {
    ...
    void givenCurrentP_whenCalculating_thenReturnP(int currentPageNumber, int totalPages, List<Integer> expected){
    ...
    static Stream<Arguments> givenCurrentP_whenCalculating_thenReturnP(){
        return Stream.of(
    ...
    @Test
    void givenNothing_whenCalling_thenReturnC(){
