...
import com.seungmin.projectboard.config.TestSecurityConfig;
import com.seungmin.projectboard.domain.constant.FormStatus;
import com.seungmin.projectboard.domain.constant.SearchType;
...
import com.seungmin.projectboard.dto.request.ArticleRequest;
import com.seungmin.projectboard.dto.response.ArticleResponse;
import com.seungmin.projectboard.service.ArticleService;
import com.seungmin.projectboard.service.PaginationService;
import com.seungmin.projectboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @Test
    public void givenKeyword_whenSearching_thenReturnsArticlesView() throws Exception {
        // Given
    ...
    @Test
    void givenPaging_whenSearchingA_thenReturnsA() throws Exception {
        // Given
    ...
    public void givenNothing_whenRequestArticle_thanReturnView() throws Exception {
        ...
        mvc.perform(get("/articles/" + articleId))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.TEXT_HTML))
                .andExpect(view().name("articles/detail")) //뷰이름 검사
    ...
    @Test
    public void givenNothing_whenRequestHashtagSearch_thanReturnView() throws Exception {
    ...
    @Test
    public void givenHashtag_whenRequestHashtagSearch_thanReturnView() throws Exception {
